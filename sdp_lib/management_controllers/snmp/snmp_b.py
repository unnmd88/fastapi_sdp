...
class ErrorResponseCheckers:
    ...
    def __init__(
        ...
        # self.error_indication = self.response[ResponseStructure.ERROR_INDICATION]
        # self.error_status = self.response[ResponseStructure.ERROR_STATUS]
        # self.error_index = self.response[ResponseStructure.ERROR_INDEX]
